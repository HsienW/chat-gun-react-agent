...
Defines backend native tool input/output contract requirements that must remain stable across planner, tool execution, resolver, and downstream consumers.
