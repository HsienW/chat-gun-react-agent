# runtime-identity-permission-governance Specification

## Purpose

TBD - created by archiving change add-runtime-identity-permission-governance. Update Purpose after archive.
