...
Defines the backend Opik evaluation pipeline: versioned dataset creation from golden cases, a deterministic tool-call-correctness metric, a bounded and versioned LLM-as-judge response-quality metric, reproducible experiments, and trace-backed evaluation feedback.
